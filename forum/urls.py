...
from forum.views import create_forum_flutter, create_reply_flutter
...
urlpatterns = [
    ...
    path('create-flutter/<int:id>/', create_forum_flutter, name='create_forum_flutter'),
    path('<int:bookid>/create-reply-flutter/<int:id>/', create_reply_flutter, name='create_reply_flutter'),
